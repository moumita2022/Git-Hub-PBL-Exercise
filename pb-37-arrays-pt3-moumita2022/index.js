...
/* function isFourLetters(arr) {
     let fourLetterArr =[]
     for (i in arr){ // (let i = 0; i< array.length ;i ++ ) {// i in array is array // for of is an object
         if (arr[i].length === 4) {
             fourLetterArr.push(arr[i])
         }
     }
     return fourLetterArr // .toString() // to convert to array to string 
