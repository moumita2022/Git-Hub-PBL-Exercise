...
let firstName = "Moumita";
let lastName = "Chakraborty";
console.log(firstName + " " + lastName); // concatination method
...
let name=  "Moumita Chakraborty";
let city=  "Munich";
let job=   "webDeveloper";
let age=    30;
let hobby= "traveling";
console.log(`Console log the variables=>My name is ${name} ,I live in ${city} ,I work as a ${job},I am ${age}years old and I love ${hobby}.`); // bactics method
...
console.log(`Console log the variables=>My name is ${name} ,I live in ${city} ,I work as a ${job},I am ${age}years old and I love ${hobby}.`); // Back-ticks 
console.log("My name is "+ name +",I live in "+ city + ",I work as a "+ job +",I am " +age + "years old and I love " + hobby+"."); // Concatination Method.